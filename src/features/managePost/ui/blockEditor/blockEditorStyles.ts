...
export const CODE_BLOCK_COLUMN_CLASS =
    "w-full min-w-0 tablet:flex-1 tablet:min-w-[calc((var(--size-tablet)-(1.6rem*10))/2)] bg-[#ffffff] rounded-[2.4rem] flex flex-col gap-[2.4rem]";
    // "w-full min-w-0 tablet:flex-1 tablet:min-w-[calc((var(--size-tablet)-(1.6rem*10))/2)] p-[1.6rem] bg-[#ffffff] rounded-[2.4rem] flex flex-col gap-[2.4rem]";
