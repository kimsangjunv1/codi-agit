...
const HomeViewModeFloatingMenu = () => {
    ...
    return (
        <motion.nav
            ...
            className="fixed z-100 left-1/2 -translate-x-1/2 bottom-[1.6rem] flex items-center gap-[0.8rem] px-[2.0rem] py-[1.6rem] rounded-full bg-black backdrop-blur-md shadow-[var(--shadow-normal)] max-w-[calc(100dvw-3.2rem)]"
